          ...
          <div class="container">
                <div class="collapse navbar-collapse w-100" id="nav_principal">
                    <ul class="nav nav-justified w-100 flex-column flex-sm-row">
                        <li class="nav-item">
                              <a href="devolvertarea.php" class="nav-link">Devolver Tarea</a>
                        </li>
                        <li class="nav-item">
                              <a href="reportarproblema.php" class="nav-link">Reportar problema</a>
                        </li> 
                        <li class="nav-item">
                              <a href="vertareaA.php" class="nav-link">Ver tareas Asignadas</a>
                        </li> 
                        <?php
                            if(($_SESSION["name"] !=' ')) {
                        ?>
